...
- **AddSingleProductTest.java** — tests adding a single product to the cart
- **AddMultipleProductsTest.java** — tests adding six products to the cart
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/BrutaruMihaiGeorgian/Projects_Automation_Testing/tree/ProjectsAutomationTesting/src
   ```
...
| `CheckoutTest`  | Tests adding six products to the cart         |
